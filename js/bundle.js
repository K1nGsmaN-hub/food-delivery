...
function calc() {
  ...
  function getStaticInfo(parentSelector, activeClass) {
    var elems = document.querySelectorAll("".concat(parentSelector, " div"));
...
function cards() {
  var MenuItem = /*#__PURE__*/function () {
    function MenuItem(imgPath, imgAlt, title, text, price) {
    ...
    _createClass(MenuItem, [{
      ...
      value: function makePrice() {
        ...
        total.textContent = "".concat(this.price);
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["getResource"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formsSelector, timeOutID) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMsg = document.createElement('img'); // added spinner elem
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // covert formData to JSON

      Object(_services_services__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', json).then(function () {
  ...
  function showThanksModal(msg) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModalWindow"])('.modal', timeOutID);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["closeModalWindow"])('.modal');
    }, 4000);
  }
}
...
/*!*****************************!*\
  !*** ./js/modules/modal.js ***!
  \*****************************/
/*! exports provided: default, openModalWindow, closeModalWindow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function modal(triggerSelector, modalSelector, timeOutID) {
  var btnsOpenModal = document.querySelectorAll(triggerSelector),
...
function slider(_ref) {
  var container = _ref.container,
      ...
      curCounter = _ref.curCounter,
      totCounter = _ref.totCounter,
      wrapper = _ref.wrapper,
      field = _ref.field;
  var offerSlider = document.querySelector(container),
  ...
  totalSliderCounter.textContent = offerSlides.length < 10 ? "0".concat(offerSlides.length) : offerSlides.length;
  var offset = 0;
  slidesField.style.width = "".concat(100 * offerSlides.length, "%");
  slidesField.style.display = 'flex';
  slidesField.style.transition = '0.5s all';
  sliderWrapper.style.overflow = 'hidden';
  offerSlides.forEach(function (item) {
    item.style.width = widthField;
  });
  offerSlider.style.position = 'relative'; // slider indicators
  ...
  for (var i = 0; i < offerSlides.length; i++) {
    ...
    dot.setAttribute('data-slide-to', "".concat(i + 1));
  ...
  prevBtn.addEventListener('click', function () {
    ...
    if (+curSliderCounter.textContent === 1) {
      ...
      curSliderCounter.textContent = +curSliderCounter.textContent < 10 ? "0".concat(+curSliderCounter.textContent - 1) : +curSliderCounter.textContent - 1;
    }
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      slidesField.style.transform = "translateX(-".concat(offset, "px)");
      curSliderCounter.textContent = slideTo < 10 ? "0".concat(slideTo) : slideTo;
      changeDotStyle();
    });
  });
...
window.addEventListener('DOMContentLoaded', function () {
  var timeOutID = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["openModalWindow"])('.modal', timeOutID);
  }, 15000);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', timeOutID);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])('form', timeOutID);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-09-01');
